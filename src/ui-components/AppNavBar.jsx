      ...
      >
        ...
        >
          <div className="relative">
            <IconShoppingCart viewBox={{ width: 35, height: 35 }} />
            <div className="absolute left-2 -top-3 text-red-500 font-bold">
              <span>{totalItems}</span>
            </div>
          </div>
        </Button>
        <div className="flex flex-1 justify-end">
          <button className="border-2 m-2 w-16" onClick={() => props.signOut()}>
            Logout
          </button>
        </div>
      </Flex>
